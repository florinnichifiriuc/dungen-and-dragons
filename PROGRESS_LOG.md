...
| 2025-11-24 19:30 | Campaign AI Stewardship Enhancements | Landed AI steward panels and quick presets for task board, lore entries, and quests, introduced quest/task idea endpoints to UI, and added fallback coverage plus tile template image upload tests. |
