            ...
            <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[minmax(0,2.5fr),minmax(0,1fr)]">
                ...
                <aside className="space-y-4">
                    <AiIdeaPanel
                        ...
                        title="Summon the lore steward"
                        description="Offer a handful of keywords, relationships, or mysteries. The steward suggests names, aliases, tags, and evocative summaries you can apply instantly."
                        submitLabel="Generate lore idea"
                        applyLabel="Use this lore"
                    ...
                    <section className="rounded-xl border border-amber-500/30 bg-amber-900/20 p-4 shadow-inner shadow-amber-900/30">
                        ...
                        <p className="mt-1 text-xs text-amber-200/80">Choose a pre-written spark to prefill the form.</p>
