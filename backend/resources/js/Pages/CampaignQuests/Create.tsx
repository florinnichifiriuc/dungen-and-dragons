            ...
            <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[minmax(0,2.2fr),minmax(0,1fr)]">
                ...
                <aside className="space-y-4">
                    <AiIdeaPanel
                        ...
                        title="Summon the quest mentor"
                        description="Share hooks, stakes, or desired rewards. The mentor will propose a title, summary, detailed brief, and objective list you can apply."
                        submitLabel="Generate quest brief"
                        applyLabel="Use this quest"
                    ...
                    <section className="rounded-xl border border-indigo-500/30 bg-indigo-950/30 p-4 shadow-inner shadow-indigo-900/30">
                        <h3 className="text-sm font-semibold text-indigo-100">Quick quest sparks</h3>
                        <p className="mt-1 text-xs text-indigo-200/80">Drop in a preset arc to prefill the form instantly.</p>
