            ...
            <section className="space-y-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <article className="rounded-xl border border-zinc-800 bg-zinc-900/70 p-6 shadow-inner shadow-black/40">
                        ...
                        <p className="mt-2 text-sm text-zinc-400">Invite new parties, reassign DMs, or trigger AI coverage once group management ships.</p>
                        <Button variant="outline" size="sm" className="mt-4">Open groups</Button>
                    </article>
                    <article className="rounded-xl border border-zinc-800 bg-zinc-900/70 p-6 shadow-inner shadow-black/40">
